...
print(f'ENPV value: {main([470.68, 35, 0.75, 2.5, 0.15])}') #Use this to optimise ENPV
# print(f'ENPV value: {main([214.8857, 5.3614, 0.004, 4.9803, 0.4071])}') #Use this for sensitivity analysis